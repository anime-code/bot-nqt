...
const reminders = [
    { time: '0 59 8 * * 1-5', message: 'Nay cuối tuần toàn mời mọi người đồ ăn nhé!' }, // 08:59 thứ 2-6
    { time: '0 0 12 * * 1-5', message: 'Nghỉ trưa thôi mọi người' }, // 12:00 thứ 2-6
    { time: '0 55 16 * * 1-5', message: 'Nhớ đừng quên daily report nhé: https://work-report.thk-hd-hn.vn/' }, // 16:45 thứ 2-6
];
